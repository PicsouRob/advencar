...
const idSchema = z.number({
    message: "El id del tipo de vehículo debe ser un número."
}).int({
    message: "El id del tipo de vehículo debe ser un número entero."
}).positive({
    message: "El id del tipo de vehículo debe ser positivo."
});
