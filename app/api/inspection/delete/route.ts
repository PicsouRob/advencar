...
const idSchema = z.number({
    message: "El id de la inspección debe ser un número."
}).int({
    message: "El id de la inspección debe ser un número entero."
}).positive({
    message: "El id de la inspección debe ser positivo."
});
